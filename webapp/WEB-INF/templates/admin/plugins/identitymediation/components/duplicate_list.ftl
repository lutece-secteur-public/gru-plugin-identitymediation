<#if current_rule_code?has_content && duplicate_rule_list?has_content && mediation_identity_list?has_content && current_page??>
    ...
    <nav aria-label="Pagination" class="border-top">
        <ul class="pagination justify-content-center mt-3 mb-0">
            <li class="page-item <#if current_page == 1>disabled</#if>">
                <a class="page-link" href="jsp/admin/plugins/identitymediation/IdentityDuplicate.jsp?view_searchDuplicates&code=${current_rule_code}&page=${current_page - 1}" tabindex="-1" aria-disabled="true"><i class="ti ti-chevron-left"></i></a>
            </li>
            <#if total_pages gt 6>
            <li class="page-item">
            ...
            <#else>
                ...
                <li class="page-item <#if current_page == page>border-primary-subtle border-end border-top-0 border-start-0 border-bottom-0</#if>">
                    <a class="page-link <#if current_page == page>text-primary-emphasis bg-primary-subtle border border-primary-subtle border-end</#if> <#if current_page == page - 1>border-start-0</#if>" href="jsp/admin/plugins/identitymediation/IdentityDuplicate.jsp?view_searchDuplicates&code=${current_rule_code}&page=${page}">${page}</a>
                </li>
                </#list>
            </#if>
            <li class="page-item <#if current_page == total_pages>disabled</#if>">
                <a class="page-link" href="jsp/admin/plugins/identitymediation/IdentityDuplicate.jsp?view_searchDuplicates&code=${current_rule_code}&page=${current_page + 1}"><i class="ti ti-chevron-right"></i></a>
            </li>
        </ul>
    </nav>
  </@pageColumn>
